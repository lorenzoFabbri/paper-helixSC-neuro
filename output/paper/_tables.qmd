...
```
**Pairwise differences between marginal contrasts on the logarithmic scale of males and females, for the effect of a increase from the 10th to the 90th percentile of {{< acr edcs first_use=true >}} on {{< acr hitrtse first_use=true >}}, expressed in {{< acr mss >}}, and on the glucocorticosteroids, expressed in ng/ml (HELIX subcohort; 2013-2016).**
:::
...
```
**Pairwise differences between marginal contrasts on the logarithmic scale of males and females, for the effect of a increase from the 10th to the 90th percentile of the glucocorticosteroids on {{< acr hitrtse first_use=true >}} expressed in {{< acr mss >}} (HELIX subcohort; 2013-2016).**
:::
