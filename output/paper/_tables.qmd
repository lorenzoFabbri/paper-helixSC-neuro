...
```
**Pairwise differences between marginal contrasts of males and females, for the effect of a decrease from the 90th to the 10th percentile of {{< acr edcs first_use=true >}} on {{< acr hitrtse first_use=true >}}, expressed in {{< acr mss >}}, and on the glucocorticosteroids, expressed in ng/ml (HELIX subcohort; 2013-2016).**
:::
...
```
**Pairwise differences between marginal contrasts of males and females, for the effect of a decrease from the 90th to the 10th percentile of the glucocorticosteroids on {{< acr hitrtse first_use=true >}} expressed in {{< acr mss >}} (HELIX subcohort; 2013-2016).**
:::
