...
```
Classification of the measured corticosteroids, by cohort.
:::
...
#ret_adrfs[[2]]
```
Average dose-response functions for...
:::
...
```
Marginal comparison results for $hitrtse \sim edc \times sex$
:::
...
```
Marginal comparison results for $metabolite \sim edc \times sex$
:::
...
```
Marginal comparison results for $hitrtse \sim metabolite \times sex$
:::
