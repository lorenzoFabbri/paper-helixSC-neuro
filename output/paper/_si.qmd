...
codebook_1
```
**Codebook for the covariates used in the estimation of the marginal comparisons of {{< acr edcs first_use=true >}} on {{< acr hitrtse first_use=true >}}.**
:::
...
codebook_2
```
**Codebook for the covariates used in the estimation of the marginal comparisons of {{< acr edcs first_use=true >}} on the glucocorticosteroids.**
:::
...
codebook_3
```
**Codebook for the covariates used in the estimation of the marginal comparisons of the glucocorticosteroids on {{< acr hitrtse first_use=true >}}.**
:::
...
```
**Marginal contrasts for effect modification by sex of a decrease from the 90th to the 10th percentile of the {{< acr edcs first_use=true >}} on {{< acr hitrtse first_use=true >}} expressed in {{< acr mss >}} (HELIX subcohort; 2013-2016).** 
...
```
**Marginal contrasts for effect modification by sex of a decrease from the 90th to the 10th percentile of the {{< acr edcs first_use=true >}} on the glucocorticosteroids expressed in ng/ml (HELIX subcohort; 2013-2016).** 
Circles and triangles indicate effect estimates. Solid lines indicate the $95\%$ {{< acr ci >}}. The size of the circles represents the *S* value of the effect estimate [@RafiGreenland:2020].
:::
...
```
**Marginal contrasts for effect modification by sex of a decrease from the 90th to the 10th percentile of the glucocorticosteroids on {{< acr hitrtse first_use=true >}} expressed in {{< acr mss >}} (HELIX subcohort; 2013-2016).** 
