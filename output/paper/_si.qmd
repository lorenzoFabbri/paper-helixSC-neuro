...
```
Effective sample size before and after balancing weights estimation (exposures: \acr{edcs}; outcome: \acr{hitrtse}).
:::
...
```
Effective sample size before and after balancing weights estimation (exposures: \acr{edcs}; outcomes: glucocorticosteroids).
:::
...
```
Effective sample size before and after balancing weights estimation (exposures: glucocorticosteroids; outcome: \acr{hitrtse}).
:::
...
```
Summary statistics of the estimated balancing weights (exposures: \acr{edcs}; outcome: \acr{hitrtse}).
:::
...
```
Summary statistics of the estimated balancing weights (exposures: \acr{edcs}; outcomes: glucocorticosteroids).
:::
...
```
Summary statistics of the estimated balancing weights (exposures: glucocorticosteroids; outcome: \acr{hitrtse}).
:::
...
```
Summary statistics of the estimated balancing weights for effect modification (exposures: \acr{edcs}; outcome: \acr{hitrtse}; modifier: sex).
:::
...
```
Summary statistics of the estimated balancing weights for effect modification (exposures: \acr{edcs}; outcomes: glucocorticosteroids; modifier: sex).
:::
...
```
Summary statistics of the estimated balancing weights for effect modification (exposures: glucocorticosteroids; outcome: \acr{hitrtse}; modifier: sex).
:::
...
```
**Measurement classification of \acr{edcs}, by cohort.**
...
```
**Measurement classification of the glucocorticosteroids, by cohort.**
