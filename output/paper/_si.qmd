...
```
**Information about non-persistent {{< acr edcs >}}, including the full compound name, the standard symbol, the used variable name, the identifier from PubChem, and the parental compound.**
:::
...
```
Flowchart describing thew sample size for each research question.
:::
...
```
**Marginal contrasts for effect modification by sex of a decrease from the 90th to the 10th percentile of the {{< acr edcs >}} on {{< acr hitrtse >}} (HELIX subcohort; 2013-2016).** 
...
```
**Marginal contrasts for effect modification by sex of a decrease from the 90th to the 10th percentile of the {{< acr edcs >}} on the glucocorticosteroids (HELIX subcohort; 2013-2016).** 
Circles and triangles indicate effect estimates. Solid lines indicate the $95\%$ {{< acr ci >}}.
:::
...
```
**Marginal contrasts for effect modification by sex of a decrease from the 90th to the 10th percentile of the glucocorticosteroids on {{< acr hitrtse >}} (HELIX subcohort; 2013-2016).** 
Circles and triangles indicate effect estimates. Solid lines indicate the $95\%$ {{< acr ci >}}.
:::
