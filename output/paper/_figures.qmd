...
```
**Marginal contrasts for the effect of a decrease from the 90th to the 10th percentile of the {{< acr edcs >}} on {{< acr hitrtse >}} (HELIX subcohort; 2013-2016).** 
...
```
**Marginal contrasts for the effect of a decrease from the 90th to the 10th percentile of the {{< acr edcs >}} on the glucocorticosteroids (HELIX subcohort; 2013-2016).** 
...
```
**Marginal contrasts for the effect of a decrease from the 90th to the 10th percentile of the glucocorticosteroids on {{< acr hitrtse >}} (HELIX subcohort; 2013-2016).** 
Circles indicate effect estimates. Solid lines indicate the $95\%$ {{< acr ci >}}.
:::
