...
```
**Marginal contrasts (exposures: \acr{edcs}; outcome: \acr{hitrtse}) (HELIX subcohort; 2013-2016).** 
...
```
**Marginal contrasts (exposures: \acr{edcs}; outcomes: glucocorticosteroids) (HELIX subcohort; 2013-2016).** 
...
```
**Marginal contrasts (exposures: glucocorticosteroids; outcome: \acr{hitrtse}) (HELIX subcohort; 2013-2016).** 
Circles indicate effect estimates. Solid lines indicate the $95\%$ \acr{ci}.
:::
