...
We further estimated the {{< acr adrf >}} using the `avg_predictions` function from the `marginaleffects` R package, examining 50 exposure values from the 10th to the 90th percentiles of the exposure. As done for the {{< acr mcs >}}, we included the estimated balancing weights and used cohort as a clustering variable when computing robust standard errors.
...
@Fig-marginal-1 presents the forest plot for the {{< acr mcs >}} of the non-persistent {{< acr edcs >}} on {{< acr hitrtse >}}. For most {{< acr edcs >}}, a cohort-specific increase in the levels of the exposures from the 10th to the 90th percentiles was associated with a positive {{< acr mc >}}, indicating an increase in the values of {{< acr hitrtse >}}. Most of the {{< acr cis first_use=true >}} included the null effect, though. Statistically significant effects were observed for the phenol MEPA (`r format_res(meffects1, "mepa", "HRT-SE")`), and the phthalate metabolites oxo-MiNP (`r format_res(meffects1, "oxominp", "HRT-SE")`), oh-MiNP (`r format_res(meffects1, "ohminp", "HRT-SE")`), and MEHP (`r format_res(meffects1, "mehp", "HRT-SE")`). The {{< acr opp >}} DETP was strongly negatively associated with {{< acr hitrtse >}} (`r format_res(meffects1, "detp", "HRT-SE")`).

@Fig-marginal-2 presents the forest plot for the {{< acr mcs >}} of the non-persistent {{< acr edcs >}} on cortisone production, cortisol production, and corticosterone production. For most {{< acr edcs >}}, a cohort-specific increase in the levels of the exposures from the 10th to the 90th percentiles was associated with a positive {{< acr mc >}}, indicating an increase in the total production of these metabolites. Exceptions were BUPA, which was associated with negative {{< acr mcs >}} for all three outcomes, and MiBP, which was associated with a negative {{< acr mc >}} for total cortisone production only.
