...
@Fig-marginal-3 presents the forest plot for the marginal effects of the corticosteroids on \acr{hitrtse}.

Results are presented as effect estimate of the marginal contrast and the $95\%$ \acr{ci}.
