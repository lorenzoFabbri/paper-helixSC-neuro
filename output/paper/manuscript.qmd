...
Levels of unprocessed non-persistent \acr{edcs} and glucocorticosteroids, by cohort and overall, are presented in @tbl-edc-desc and @tbl-met-desc, respectively.
...
Our results are consistent with prior research that associated exposure to certain \acr{edcs} with higher levels of urinary and hair cortisol [@KimLeeMoon:2018; @SearsLiuLanphear:2023]. Contrary to these prior studies, we did find effect modification by sex. We are not aware of other epidemiological studies investigating phthalates metabolites, phenols, and \acr{opps}, in relation to urinary glucocorticosteroids in childhood.
We are also not aware of prior studies specifically investigating the effects of exposure to \acr{edcs} and elevated levels of glucocorticosteroids in relation to \acr{hitrtse}.
