...
@Fig-marginal-1 presents the forest plot for the {{< acr mcs >}} of the non-persistent {{< acr edcs >}} on {{< acr hitrtse >}}. For most {{< acr edcs >}}, a cohort-specific increase in the levels of the exposures from the 10th to the 90th percentiles was associated with a positive {{< acr mc >}}, indicating an increase in the values of {{< acr hitrtse >}}. Most of the {{< acr cis first_use=true >}} included the null effect, though. Statistically significant effects were observed for the phenol MEPA (`r format_res(meffects1, "mepa", "hitrtse")`), and the phthalate metabolites oxo-MiNP (`r format_res(meffects1, "oxominp", "hitrtse")`), oh-MiNP (`r format_res(meffects1, "ohminp", "hitrtse")`), and MEHP (`r format_res(meffects1, "mehp", "hitrtse")`). The {{< acr opp >}} DETP was strongly negatively associated with {{< acr hitrtse >}} (`r format_res(meffects1, "detp", "hitrtse")`).
